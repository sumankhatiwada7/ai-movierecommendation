  ...
  useEffect(() => {
    ...
    async function loadHomepage() {
      try {
        ...
        // Fetch genre rows only if we have genres
    ...
    return (
      <div className="bg-black min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">Loading your homepage...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="bg-black min-h-screen flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">No movies available</h2>
  ...
  return (
    <div className="bg-black min-h-screen text-white pb-12">
      ...
      <div className="mt-6 space-y-6">
        {/* Only show rows if they have movies */}
        ...
        {/* Fallback if only genres but no other content */}
        {recommended.length === 0 && trending.length === 0 && newReleases.length === 0 && genreRows.length > 0 && (
          <p className="text-gray-400 text-center px-6">Browse by genre below</p>
        )}
      </div>
    </div>
  );
